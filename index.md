...
Framing of Immigration in News Stories (with [Olga Gasparyan](https://olgasparyan.com/) and Michelle Torres)* (**``CPB``**) (**``PC``**)   
...
- *Using Visual Sentiment Labeling to Address Annotator Bias (with [Olga Gasparyan](https://olgasparyan.com/) and Michelle Torres)* (**``CPB``**) (**``PC``**)   
