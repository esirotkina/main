...
- Reading Between the Eyes: A Framework for Recovering (Political) Identity from Eye‑Tracking Weak Signal
  <p style="margin-left: 45px;">  <font size="-1"> I build a classifier that combines computer vision with gaze data to predict political identity from political imagery,  which is the first model in computational political science that learns identity from a weak behavioral signal. </font>  </p>
